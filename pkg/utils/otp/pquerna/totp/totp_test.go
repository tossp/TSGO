...
var (
	...
	rfcMatrixTCs = []tc{
		{59, "94287082", pquerna.AlgorithmSHA1, secSha1},
		{59, "46119246", pquerna.AlgorithmSHA256, secSha256},
		{59, "90693936", pquerna.AlgorithmSHA512, secSha512},
		{1111111109, "07081804", pquerna.AlgorithmSHA1, secSha1},
		{1111111109, "68084774", pquerna.AlgorithmSHA256, secSha256},
		{1111111109, "25091201", pquerna.AlgorithmSHA512, secSha512},
		{1111111111, "14050471", pquerna.AlgorithmSHA1, secSha1},
		{1111111111, "67062674", pquerna.AlgorithmSHA256, secSha256},
		{1111111111, "99943326", pquerna.AlgorithmSHA512, secSha512},
		{1234567890, "89005924", pquerna.AlgorithmSHA1, secSha1},
		{1234567890, "91819424", pquerna.AlgorithmSHA256, secSha256},
		{1234567890, "93441116", pquerna.AlgorithmSHA512, secSha512},
		{2000000000, "69279037", pquerna.AlgorithmSHA1, secSha1},
		{2000000000, "90698825", pquerna.AlgorithmSHA256, secSha256},
		{2000000000, "38618901", pquerna.AlgorithmSHA512, secSha512},
		{20000000000, "65353130", pquerna.AlgorithmSHA1, secSha1},
		{20000000000, "77737706", pquerna.AlgorithmSHA256, secSha256},
		{20000000000, "47863826", pquerna.AlgorithmSHA512, secSha512},
	}
)
...
func TestValidateSkew(t *testing.T) {
	...
	tests := []tc{
		{29, "94287082", pquerna.AlgorithmSHA1, secSha1},
		{59, "94287082", pquerna.AlgorithmSHA1, secSha1},
		{61, "94287082", pquerna.AlgorithmSHA1, secSha1},
	}
...
func TestGoogleLowerCaseSecret(t *testing.T) {
	w, err := pquerna.NewKeyFromURL(`otpauth://totp/Google%3Afoo%40example.com?secret=qlt6vmy6svfx4bt4rpmisaiyol6hihca&issuer=Google`)
	require.NoError(t, err)
	sec := w.Secret()
