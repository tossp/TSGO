...
var (
	...
	rfcMatrixTCs = []tc{
		{0, "755224", pquerna.AlgorithmSHA1, secSha1},
		{1, "287082", pquerna.AlgorithmSHA1, secSha1},
		{2, "359152", pquerna.AlgorithmSHA1, secSha1},
		{3, "969429", pquerna.AlgorithmSHA1, secSha1},
		{4, "338314", pquerna.AlgorithmSHA1, secSha1},
		{5, "254676", pquerna.AlgorithmSHA1, secSha1},
		{6, "287922", pquerna.AlgorithmSHA1, secSha1},
		{7, "162583", pquerna.AlgorithmSHA1, secSha1},
		{8, "399871", pquerna.AlgorithmSHA1, secSha1},
		{9, "520489", pquerna.AlgorithmSHA1, secSha1},
	}
)
...
func TestValidateInvalid(t *testing.T) {
	...
	valid, err := ValidateCustom("foo", 11, secSha1,
		ValidateOpts{
			Digits:    pquerna.DigitsSix,
			Algorithm: pquerna.AlgorithmSHA1,
		})
	require.Equal(t, pquerna.ErrValidateInputInvalidLength, err, "Expected Invalid length error.")
...
func TestGenerate(t *testing.T) {
	...
	require.Equal(t, pquerna.ErrGenerateMissingIssuer, err, "generate missing issuer")
	...
	require.Equal(t, pquerna.ErrGenerateMissingAccountName, err, "generate missing account name.")
	require.Nil(t, k, "key should be nil on error.")
