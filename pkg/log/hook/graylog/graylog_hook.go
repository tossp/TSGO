...
func getCallerIgnoringLogMulti(callDepth int) (string, int) {
	...
	return getCaller(callDepth+1, "core/db/logger.go", "core/log/func.go", "core/log/echo.go",
		"logrus@v1.2.0/hooks.go", "logrus@v1.2.0/entry.go", "logrus@v1.2.0/logger.go", "logrus@v1.2.0/exported.go",
		"asm_amd64.s")
}
